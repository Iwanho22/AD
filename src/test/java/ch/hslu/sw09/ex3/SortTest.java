...
class SortTest {
    ...
    void testSelectionSort(String dataString, String expedtedString) {
        // arrange
        var data = Arrays.stream(dataString.split(":")).map(Integer::parseInt).toArray(Integer[]::new);
        var expected = Arrays.stream(expedtedString.split(":")).map(Integer::parseInt).toArray(Integer[]::new);
    ...
    void testBubbleSort(String dataString, String expedtedString) {
        // arrange
        var data = Arrays.stream(dataString.split(":")).map(Integer::parseInt).toArray(Integer[]::new);
        var expected = Arrays.stream(expedtedString.split(":")).map(Integer::parseInt).toArray(Integer[]::new);
    ...
    void testBubbleSort2(String dataString, String expedtedString) {
        // arrange
        var data = Arrays.stream(dataString.split(":")).map(Integer::parseInt).toArray(Integer[]::new);
        var expected = Arrays.stream(expedtedString.split(":")).map(Integer::parseInt).toArray(Integer[]::new);
