 ...
 */
package ch.hslu.sw08.ex4.queue;
 ...
 */
public final class DemoConcurrentListArrayBlocking {

    private static final Logger LOG = LoggerFactory.getLogger(DemoConcurrentListArrayBlocking.class);

    /**
     * Privater Konstruktor.
     */
    private DemoConcurrentListArrayBlocking() {
    }
    ...
    public static void main(final String[] args) throws InterruptedException, ExecutionException {
        final ArrayBlockingQueue<Integer> list = new ArrayBlockingQueue<>(3000, false);
